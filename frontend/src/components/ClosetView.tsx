    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/80 backdrop-blur-md p-4 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            type="text"
            placeholder="Nach Farbe, Stoff, Name filtern..."
            value={searchQuery}
      ...
      {filteredItems.length > 0 ? (
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl p-10 text-center border border-slate-200 shadow-sm">
          ...
          <h3 className="text-lg font-bold text-slate-900">
            {items.length === 0 ? 'Dein digitaler Kleiderschrank ist leer' : 'Keine passenden Kleidungsstücke gefunden'}
          </h3>
          <p className="text-sm text-slate-500 max-w-md mx-auto mt-1.5 mb-6">
            {items.length === 0
              ? 'Lade Fotos deiner Oberteile, Hosen und Schuhe hoch, damit der KI-Stylist Outfits für dich zusammenstellen kann.'
              : 'Versuche, deine Suchfilter zurückzusetzen, um deine anderen Kleidungsstücke anzuzeigen.'}
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              ...
              <span>Kleidungsfoto hochladen</span>
            </button>
